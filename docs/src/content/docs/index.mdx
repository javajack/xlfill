---
title: XLFill
description: Template-first Excel report generation for Go. Design in Excel, fill with Go.
template: splash
hero:
  tagline: You already know how to make a great-looking spreadsheet. Now let your Go app fill it with data — without writing a single line of styling code.
  actions:
    - text: See why it's better
      link: /guides/why-xlfill/
      icon: right-arrow
...
You know that feeling when you open Excel and just *make* a report look right? The fonts, the colors, the borders — it takes a few minutes and it looks professional. Now imagine your Go application could just... fill that in with live data. That's XLFill.
...
<CardGrid>
	<Card title="See the full case" icon="open-book">
		Read [Why XLFill?](/guides/why-xlfill/) — a detailed breakdown with real Go code showing 40+ lines of hard-coded pain reduced to 3 lines.
	</Card>
	<Card title="Just try it" icon="rocket">
		[Get started](/guides/getting-started/) — install, build a template, fill it with data. Five minutes, start to finish.
	</Card>
</CardGrid>
