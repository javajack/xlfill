      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "jx:repeat", slug: "commands/repeat" },
            ...
            { label: "jx:include", slug: "commands/include" },
            { label: "jx:table", slug: "commands/table" },
            { label: "jx:chart", slug: "commands/chart" },
            { label: "jx:sparkline", slug: "commands/sparkline" },
            { label: "jx:conditionalFormat", slug: "commands/conditionalformat" },
            { label: "jx:dataValidation", slug: "commands/datavalidation" },
            { label: "jx:definedName", slug: "commands/definedname" },
            { label: "jx:group", slug: "commands/group" },
            { label: "jx:autoRowHeight", slug: "commands/autorowheight" },
            { label: "jx:autoColWidth", slug: "commands/autocolwidth" },
            { label: "jx:freezePanes", slug: "commands/freezepanes" },
            { label: "jx:pageBreak", slug: "commands/pagebreak" },
            { label: "jx:protect", slug: "commands/protect" },
          ],
        },
        {
          label: "Patterns",
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Feature Comparison", slug: "reference/comparison" },
